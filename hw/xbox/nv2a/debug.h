...
#define NV2A_PROF_COUNTERS_XMAC \
    ...
    _X(NV2A_PROF_SURF_TO_TEX_OK) \
    _X(NV2A_PROF_SURF_TO_TEX_NO_SURFACE) \
    _X(NV2A_PROF_SURF_TO_TEX_FAIL_DIM) \
    _X(NV2A_PROF_SURF_TO_TEX_FAIL_PITCH) \
    _X(NV2A_PROF_SURF_TO_TEX_FAIL_OFFSET) \
    _X(NV2A_PROF_SURF_TO_TEX_FAIL_ORIGIN) \
    _X(NV2A_PROF_SURF_TO_TEX_FAIL_BOUNDS) \
    _X(NV2A_PROF_SURF_TO_TEX_FAIL_ZETA) \
    _X(NV2A_PROF_SURF_TO_TEX_ZETA_Z16) \
    _X(NV2A_PROF_SURF_TO_TEX_ZETA_Z24S8) \
    _X(NV2A_PROF_SURF_TO_TEX_ZETA_FIXED) \
    _X(NV2A_PROF_SURF_TO_TEX_ZETA_FLOAT) \
    _X(NV2A_PROF_SURF_TO_TEX_ZETA_TEX_Y16) \
    _X(NV2A_PROF_SURF_TO_TEX_ZETA_TEX_X8Y24) \
    _X(NV2A_PROF_SURF_TO_TEX_ZETA_TEX_OTHER) \
    _X(NV2A_PROF_SURF_TO_TEX_ZETA_OK) \
    _X(NV2A_PROF_SURF_TO_TEX_ZETA_COPY) \
    _X(NV2A_PROF_SURF_TO_TEX_STORAGE_ALLOC) \
    _X(NV2A_PROF_SURF_TO_TEX_STORAGE_REUSE) \
    _X(NV2A_PROF_SURF_TO_TEX_FAIL_CUBEMAP) \
    _X(NV2A_PROF_SURF_TO_TEX_FAIL_MIPMAP) \
    _X(NV2A_PROF_SURF_TO_TEX_FAIL_FORMAT) \
    _X(NV2A_PROF_SURF_TO_TEX_FALLBACK_OVERLAP) \
    _X(NV2A_PROF_SURF_TO_TEX_FALLBACK_DOWNLOAD) \
    _X(NV2A_PROF_SURF_TO_TEX_FALLBACK_CACHE) \
    _X(NV2A_PROF_SURF_TO_TEX_FALLBACK_ZETA_OVERLAP) \
    _X(NV2A_PROF_SURF_TO_TEX_FALLBACK_ZETA_DOWNLOAD) \
    _X(NV2A_PROF_SURF_TO_TEX_FALLBACK_ZETA_CLEAN) \
